...
class Products(models.Model):
    ...
    # Color Choices
    COLOR_CHOICES = [
        ('Khaki', 'Khaki'), ('Neon', 'Neon'), ('Printed', 'Printed'),
        ('Black', 'Black'), ('Blue', 'Blue'), ('Brown', 'Brown'),
        ('Burgundy', 'Burgundy'), ('Green', 'Green'), ('Grey', 'Grey'),
        ('Navy', 'Navy'), ('Olive', 'Olive'), ('Orange', 'Orange'),
    ...
    # Activity Choices
    ACTIVITY_CHOICES = [
        ('Casual', 'Casual'), ('Dance', 'Dance'), ('Golf', 'Golf'),
        ('Hiking', 'Hiking'), ('Running', 'Running'), ('Tennis', 'Tennis'),
        ('Training', 'Training'), ('Travel', 'Travel'), ('Work', 'Work'),
        ('Workout', 'Workout'), ('Yoga', 'Yoga'),
    ]

    # Fabric Choices
    FABRIC_CHOICES = [
        ('Cotton', 'Cotton'), ('Fleece', 'Fleece'), ('Luon', 'Luon'),
        ('Mesh', 'Mesh'), ('Nulu', 'Nulu'), ('Pima Cotton', 'Pima Cotton'),
        ('Ribbed', 'Ribbed'), ('SenseKnit', 'SenseKnit'), ('Softstreme', 'Softstreme'),
        ('Swift', 'Swift'), ('Wool', 'Wool'),
    ]
    ...
    activity = models.CharField(max_length=20, choices=ACTIVITY_CHOICES, blank=True, null=True)
